...
the processed schema documented in ``docs/benchmarks/caudal_eqtl.md``:
...
Usage::
    ...
    python scripts/eqtl/build_caudal_v1_distribution.py \\
        --raw-dir data/tasks/caudal_eqtl/_intermediates_unchanged_run \\
        --gtf data/tasks/R64-1-1.115.gtf \\
        --out-dir data/tasks/caudal_eqtl \\
        --iterations 4
"""
...
benchmark. See `docs/benchmarks/caudal_eqtl.md` for the full spec.
...
across eQTL tasks). A publishable bundle copies them into the task folder.
"""
    )
